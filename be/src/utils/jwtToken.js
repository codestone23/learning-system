...
exports.signRefreshToken = async (payload, secretSignature, tokenLife) => {
  try {
    return await sign(
      {
        payload,
...
exports.verifyRefreshToken = async (refreshToken, secretKey) => {
  try {
    return await verify(refreshToken, secretKey);
  } catch (error) {
